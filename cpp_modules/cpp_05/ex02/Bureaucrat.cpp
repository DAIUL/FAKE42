...
void	Bureaucrat::executeForm(AForm const & f)
{
	...
	else if (f.getSign() == false)
		std::cout << _name << " couldn't execute " << f.getName() << " because it needs to be signed..." << std::endl; 
	else if ((f.getSign() == true) && (f.getGradeExec() < _grade))
		std::cout << _name << " couldn't execute " << f.getName() << " because their garde was too low..." << std::endl; 
}
